...
// import com.shounakmulay.telephony.utils.Constants.ACTION_MMS_DELIVERED
// import com.shounakmulay.telephony.utils.Constants.ACTION_MMS_SENT
// import com.shounakmulay.telephony.utils.Constants.MMS_BODY
...
// import com.shounakmulay.telephony.utils.Constants.MMS_TO
// import com.shounakmulay.telephony.utils.MMSContentUri
// import java.lang.RuntimeException


// class MMSController(private val context: Context) {

//     // FETCH MMS
//     fun getMessages(
//         contentUri: MMSContentUri,
...
//     // SEND MMS
//     fun sendMMS(destinationAddress: String, messageBody: String, listenStatus: Boolean) {
//         val mmsManager = getMMSManager()
//         if (listenStatus) {
//             val pendingIntents = getPendingIntents()
//             mmsManager.sendTextMessage(
//                 destinationAddress,
//                 null,
//                 messageBody,
...
//             )
//         } else {
//             // TODO: use sendMultimediaMessage instead.  SmsManager sms = SmsManager.getDefault(); sms.sendMultimediaMessage(context, writerUri, null, null, null);
//             mmsManager.sendTextMessage(destinationAddress, null, messageBody, null, null)
//         }
//     }

//     fun sendMultipartMMS(destinationAddress: String, messageBody: String, listenStatus: Boolean) {
//         val mmsManager = getMMSManager()
//         val messageParts = mmsManager.divideMessage(messageBody)
//         if (listenStatus) {
//             val pendingIntents = getMultiplePendingIntents(messageParts.size)
//             mmsManager.sendMultipartTextMessage(
//                 destinationAddress,
//                 null,
//                 messageParts,
//                 pendingIntents.first,
...
//             )
//         } else {
//             mmsManager.sendMultipartTextMessage(destinationAddress, null, messageParts, null, null)
//         }
//     }
...
//     fun sendMMSIntent(destinationAddress: String, messageBody: String) {
//         val intent = Intent(Intent.ACTION_SENDTO).apply {
//             data = Uri.parse(MMS_TO + destinationAddress)
//             putExtra(MMS_BODY, messageBody)
...
//         val sentIntent = Intent(ACTION_MMS_SENT).apply {
...
//         val deliveredIntent = Intent(ACTION_MMS_DELIVERED).apply {
//             `package` = context.applicationContext.packageName
//             flags = Intent.FLAG_RECEIVER_REGISTERED_ONLY
//         }
...
// // NOTE: there is no MMSMAnager in Android.
//     private fun getMMSManager(): SmsManager {
