...
// GRANTDO figure out incoming mms if needed.
...
//         MMSContextHolder.applicationContext = context.applicationContext
...
//             processIncomingMMS(context, group.value)
//         }
//     }
...
//      * [IncomingMMSHandler.executeDartCallbackInBackgroundIsolate] with the SMS.
//      *
//      */
//     private fun processIncomingMMS(context: Context, smsList: List<SmsMessage>) {
...
//             }
//         }
//         if (IncomingMMSHandler.isApplicationForeground(context)) {
...
// // Grant Commenting this out until we use a separate MMSMessage class
// // /**
...
//  */
// object IncomingMMSHandler : MethodChannel.MethodCallHandler {
...
//         if (MMSAction.fromMethod(call.method) == MMSAction.BACKGROUND_SERVICE_INITIALIZED) {
//             onChannelInitialized(
//                 MMSContextHolder.applicationContext
